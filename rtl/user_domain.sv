...
module user_domain import user_pkg::*; import croc_pkg::*; #(
  ...
  // OBI bus to AES Decryption accelerator
  sbr_obi_req_t user_de_obi_req;
  sbr_obi_rsp_t user_de_obi_rsp;
  ...
  assign all_user_sbr_obi_rsp[UserAESde]  = user_de_obi_rsp;
  //-----------------------------------------------------------------------------------------------
...
//-------------------------------------------------------------------------------------------------
  ...
  user_aes_en #(
    ...
    .clk_i,
    .rst_ni,
    .obi_req_i  ( user_en_obi_req ),
    .obi_rsp_o  ( user_en_obi_rsp )
  );

  // AES Decryption accelerator
  user_aes_de #(
    .ObiCfg      ( SbrObiCfg     ),
    .obi_req_t   ( sbr_obi_req_t ),
    .obi_rsp_t   ( sbr_obi_rsp_t )
