...
//============================================================
// Events and timing
bool Vtb_croc_soc::eventsPending() { return !vlSymsp->TOP.__VdlySched.empty() && !contextp()->gotFinish(); }
...
void Vtb_croc_soc___024root__trace_init_top(Vtb_croc_soc___024root* vlSelf, VerilatedFst* tracep);
...
VL_ATTR_COLD void Vtb_croc_soc___024root__trace_register(Vtb_croc_soc___024root* vlSelf, VerilatedFst* tracep);

VL_ATTR_COLD void Vtb_croc_soc::traceBaseModel(VerilatedTraceBaseC* tfp, int levels, int options) {
    (void)levels; (void)options;
    VerilatedFstC* const stfp = dynamic_cast<VerilatedFstC*>(tfp);
    if (VL_UNLIKELY(!stfp)) {
        vl_fatal(__FILE__, __LINE__, __FILE__,"'Vtb_croc_soc::trace()' called on non-VerilatedFstC object;"
            " use --trace-fst with VerilatedFst object, and --trace-vcd with VerilatedVcd object");
    }
    stfp->spTrace()->addModel(this);
    stfp->spTrace()->addInitCb(&trace_init, &(vlSymsp->TOP), name(), false, 5425);
